...
<Step title="Revisar pedidos recientes">
  El front consume `GET /pedidos` para llenar la tabla de la columna derecha; puedes realizar la misma consulta desde terminal.
  ...
  <Tip>
  El panel React muestra solo los ultimos pedidos, pero este endpoint retorna toda la cola si necesitas auditar historicos.
  </Tip>
</Step>
